...
## TuGraph-Analytics 实现 PageRank：**接口与实现**  
...
我们通过CALL语句调用具体的算法，通过YIELD定义算法的返回字段，比如page\_rank算法返回点id和page rank值两个字段，则可以通过YIELD(vid, prValue)来表示。
...
## TuGraph-Analytics 实现 PageRank：**算法注册**
